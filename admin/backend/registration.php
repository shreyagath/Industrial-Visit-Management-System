...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark"  >
  <a class="navbar-brand" href="registration.php" style="margin-right: 900px;">Homepage</a>
...
<div class="table">
    <h3><a>1. Registration Database</a></h3>
        <table>
            <tr>
        ...
        if($result->num_rows>0)
        {
            ...
            {
                echo "<tr><td>".$row["uid"]."</td><td>".$row["username"]."</td><td>".$row["email"]."</td></tr>";
            }
            echo "</table>";
        }
