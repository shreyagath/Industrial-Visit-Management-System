...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark"  >
  <a class="navbar-brand" href="registration.php" style="margin-right: 1300px;">VISITRO</a>
...
<div class="table">
    <h3><a>1. Individual Slot Booking Database</a></h3>
        <table>
            <tr>
        ...
        $sql= "SELECT * FROM `individual` WHERE iname = '$iname' ";
        ...
        else
        {
            ...
            header("refresh:0;url=../html/ihome.php");
        }
        $con->close();
        ?>
    </table>  
